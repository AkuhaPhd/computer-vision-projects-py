...
class handDetector:
    ...
    def findDistance(self, x, y, img, draw=True, r=15, t=3):
        x1, y1 = self.lmList[x][1:]
        x2, y2 = self.lmList[y][1:]
...
def main():
    ...
    while True:
        ...
        cv2.putText(img, str(int(fps)), (19, 70), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 255), 3)
